...
import {getActiveProvider} from "@/services/account/api";
...
export const ProviderSelect: React.FC<ProviderProps> = (props: ProviderProps) => {
  const [cloud, setCloud] = useState<Partial<Account.Provider>>({});
  ...
  return <><ProFormSelect
    ...
    showSearch={true}
    request={async () => {
      const res: { key: number; label: JSX.Element; value: number; obj: Account.Provider; }[] = [];
