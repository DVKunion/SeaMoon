...
import type {FormValueType} from "./CreateForm";
import {Badge, Button, Divider, Drawer, Popconfirm, Space, Tag, Tooltip} from "antd";
import {CloudProviderStatusEnum, CloudProvideTypeValueEnum, RegionEnum} from "@/enum/cloud";
import {AuthColumns, CloudRegionSelector} from "./AuthForm";
...
export type DetailProps = {
  ...
  values: Partial<Account.Provider>;
};
...
const DetailDrawer: React.FC<DetailProps> = (props) => {
  ...
  >
    <ProDescriptions
      ...
      actionRef={actionRef}
      editable={{
        onSave: async (key_path, newInfo) => {
          props.values[key_path.toString()] = newInfo[key_path.toString()];
          return true;
        },
      }}
      columns={[
