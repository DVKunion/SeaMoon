module github.com/DVKunion/SeaMoon

go 1.21

require (
	github.com/alibabacloud-go/bssopenapi-20171214/v3 v3.2.2
...
replace github.com/aliyun/fc-go-sdk => github.com/DVKunion/fc-go-sdk v0.0.0-20240229064818-0899a1e1bf52
