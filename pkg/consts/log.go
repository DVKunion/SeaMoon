...
const (
	...
	SOCKS5_ACCEPT_ERROR         string = "[Socks5] Client Accept Error"
	...
	SOCKS5_CONNECT_TRANS_ERROR  string = "[Socks5] Connect Transport Failed"
...
const (
	...
	HTTP_LISTEN_START      string = "[Http] Client Start Listen At"
	...
	CONTROLLER_START string = "[Control] start control service at"
)
